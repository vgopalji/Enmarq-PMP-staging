...
namespace CareStream.Scheduler.Migrations
{
    public partial class Initial_Migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObjectID = table.Column<string>(maxLength: 250, nullable: true),
                    UserPrincipalName = table.Column<string>(maxLength: 250, nullable: true),
                    DisplayName = table.Column<string>(maxLength: 250, nullable: true),
                    BlockSignIn = table.Column<bool>(nullable: false),
                    InitialPassword = table.Column<string>(maxLength: 500, nullable: true),
                    ...
                    Usagelocation = table.Column<string>(maxLength: 500, nullable: true),
                    StreetAddress = table.Column<string>(maxLength: 500, nullable: true),
                    State = table.Column<string>(maxLength: 100, nullable: true),
                    Country = table.Column<string>(maxLength: 100, nullable: true),
                    Office = table.Column<string>(maxLength: 500, nullable: true),
                    City = table.Column<string>(maxLength: 100, nullable: true),
                    ZIP = table.Column<string>(maxLength: 100, nullable: true),
                    OfficePhone = table.Column<string>(maxLength: 100, nullable: true),
                    MobilePhone = table.Column<string>(maxLength: 100, nullable: true),
                    InviteeEmail = table.Column<string>(maxLength: 250, nullable: true),
                    InviteRedirectURL = table.Column<string>(maxLength: 500, nullable: true),
                    SendEmail = table.Column<bool>(nullable: false),
                    CustomizedMessageBody = table.Column<string>(nullable: true),
                    Error = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BulkUser", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadBy = table.Column<string>(maxLength: 150, nullable: true),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    Action = table.Column<string>(maxLength: 100, nullable: true),
                    Status = table.Column<string>(maxLength: 100, nullable: true),
                    Error = table.Column<string>(nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BulkUserFile", x => x.Id);
                });

            AddQuartzTables(migrationBuilder);
        }
        ...
        private void AddQuartzTables(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[FK_QRTZ_TRIGGERS_QRTZ_JOB_DETAILS]') AND OBJECTPROPERTY(id, N'ISFOREIGNKEY') = 1)
